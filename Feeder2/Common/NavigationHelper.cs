...
namespace Feeder.PivotApp.Common
{
    ...
    {
        public event EventHandler OnNavigatingBack;
        ...
        public virtual void GoBack()
        {
            ...
            {
                onNavigatingBack(this, new EventArgs());
                this.Frame.GoBack();
            }
        }
        /// <summary>
        ...
        private void onNavigatingBack(object sender, EventArgs e)
        {
            var eventHandler = OnNavigatingBack;
