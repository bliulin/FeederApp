...
namespace Feeder.PivotApp.Common
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        private static ITelemetry TelemetryClient
        {
            get
            {
        ...
        private static async Task loadFeeds()
        {
            var feedRepo = InstanceFactory.GetInstance<IFeedRepository>();
            await feedRepo.LoadFeedGroupsFromStorage();
        }
